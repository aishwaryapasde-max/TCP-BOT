...
🤖 Bot Name: AdityaMods955
✅ Status: Ready to join

📱 Player will see:
AdityaMods955"S wants to join your team"
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]AdityaMods955 [00FF00]___ AdityaMods955____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @AdityaRoyall955\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]xBOTS⁷⁸⁶ [00FF00]!!
"""
...
"""
            ...
            # For example:
            title_packet = await convert_kyro_to_your_system(uid, chat_id, key, iv, nickname="AdityaMods955", title_id=title_id)
...
async def noob(target_uid, chat_id, key, iv, nickname="AdityaMods955", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][00FF00] Noobde AdityaMods955 ya meku agar tu noob bolra toh tu g a y hai
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="AdityaMods955", title_id=title_id)
              ...
              # =================== EMOTE DETECTION ONLY ===================
                    ...
                    try:
                        ...
                        if "NM" in WHITELISTED_UIDS:
                            ...
                            try:
                                ...
                                bot_uid = 13777711848
                                message_text = f" Can't accept Your request Talk to AdityaMods955"
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ WELCOME TO AdityaMods955 BOT ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000] AdityaMods955
[FFFFFF]🎯 STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]AdityaMods955
[00FF00]»»————-　★　————-««
...
[FFFFFF]⚡ BOT POWERED BY:[FF0000] AdityaMods955 
[FFFFFF]🎯 STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT TG: [FFFF00]@AdityaRoyall955
[00FF00]»»————-　★　————-««
[FF0000]█▓▒░░ ENJOY THE BOT! ░░▒▓█"""
                        # In your auto-join (Old Handler) code, find this line:
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by AdityaMods955
/bio Level 70 | Pro Player
/bio Add me: AdityaMods955
...
[b][i][FFC0CB]youtube: @YASHGAMERR46 99[/b]

[b][c][FFC0CB]subcribe: YASHGAMERR46 [FFFFFF]
 
[b][i][FFA500]telegram: @AdityaRoyall955[/b]

[b][c][FFA500]telegram contact: @AdityaRoyall955[A52A2A]
 
Enjoy the bot my friend.......

[C][B][0000FF] Created by AdityaRoyall955FF
"""
...
#==================≈===========  /HELP MENU COMMANDS ========================================
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "hello", "hi"):
                            ...
                            header = f"[C][B][FF1493]Hey User Welcome To [00FFAA]AdityaMod's BOT"
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4784101718,password=D559E41DAF3EA095AE8C88B1EFE3DE9A0518B6753471A94682010BE2EFAB4DF5")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 AdityaMods955 BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 AdityaMods955 BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 AdityaMods955 BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 AdityaMods955 BOT - ONLINE")
    print("=" * 50)
    print(f"🔹 UID: {TarGeT}")
